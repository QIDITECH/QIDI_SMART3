...
clear
git clone https://gitee.com/kenneth_lin/xindi-4-3.git
ls
rm xindi-4-3/ -rf
ls
systemctl disable makerbase-wlan0.service 
ls
systemctl stoop makerbase-wlan0.service 
...
reboot
ifconfig
systemctl status makerbase-wlan0.service 
systemctl enable makerbase-wlan0.service 
systemctl disable makerbase-net-mods.service 
reboot 
ls
ifconfig
...
ls
systemctl stop makerbase-client.service 
dpkg -r makerbase-client 
dpkg -i smart-20230221.deb 
dpkg -i smart-20230221.deb 
shutdown -P now
shutdown -P now
shutdown -P now
