...
void print_start(); //2023.5.8 CLL 打印前发送"PRINT_START"指令

void open_heater_bed_up(); //2023.5.8 CLL 新增开机引导界面

void refresh_page_open_heaterbed(); //2023.5.10 CLL 新增开机引导页面

void refresh_page_open_leveling(); //2023.5.10 CLL 开机引导自动调平

void bed_leveling_switch(bool positive); //1.1.4 CLL 新增打印热床调平
